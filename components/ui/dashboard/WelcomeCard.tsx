                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <div className="sm:flex sm:space-x-5">
                            ...
                            <div className="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
                                ...
                                <dl className="flex flex-col sm:mt-1 sm:flex-row sm:flex-wrap">
                                    <dt className="sr-only">Nationality</dt>
                                    <dd className="flex items-center text-sm font-medium capitalize text-gray-500">
                                        <Flag country={'IT'}/>
                                    </dd>
                                    <dt className="sr-only">Account status</dt>
                                    <dd className="ml-3 flex items-center text-sm font-medium capitalize text-gray-500 ">
                                        <CheckBadgeIcon
                ...
                <div
                    ...
                    {stats.map((stat) => (
                        <div key={stat.label} className="px-6 py-5 text-center text-sm font-medium">
                            <span className="text-gray-900">{stat.value}</span> <span
                            className="text-gray-600">{stat.label}</span>
                        </div>
                    ))}
                </div>
            </div>
