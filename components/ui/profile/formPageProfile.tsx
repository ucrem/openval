...
export default function FormPageProfile(){
    return(
        <>
                                ...
                                <div className="sm:col-span-4">
                                    ...
                                    <div className="mt-2">
                                        ...
                                        <div
                                            ...
                                            <span className="flex select-none items-center pl-3 text-gray-500 sm:text-sm">https://www.instagram.com/</span>
                                            <input
                                                type="text"
                                                name="instagram"
                                                id="instagram"
                                    ...
                                    <div className="mt-2">
                                        <div
                                            ...
                                            <span
                                                className="flex select-none items-center pl-3 text-gray-500 sm:text-sm">
                                                <SocialIcon network="twitch" style={{height: 25, width: 25}}/>
                                            </span>
                                            <span
                                                className="flex select-none items-center pl-3 text-gray-500 sm:text-sm">https://www.twitch.tv/</span>
                                            <input
                                                type="text"
                                                name="twitch"
                                                id="twitch"
