...
import SidebarMobile from "@/components/layout/layoutMaster/sidebarMobile";
...
export default function Sidebar(props: SidebarProps){
    ...
    return(
        <>
            {/* Transition for mobile and sidebar mobile */}
                    ...
                    <div className="fixed inset-0 flex">
                        ...
                        >
                            <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                                ...
                                <SidebarMobile navigationList={navigation} teamsList={teams}/>
                            </Dialog.Panel>
                        </Transition.Child>
                    </div>
                </Dialog>
